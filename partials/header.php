...
<body class="<?php echo $view->getBodyClass(); ?>">
	...
	<svg style="display:none;">
		<symbol id="arrow-tr" viewBox="0 0 32 32"><path d="M7.414 27.414L24 10.828V18c0 1.105.895 2 2 2s2-.895 2-2V6c0-.81-.487-1.538-1.235-1.848-.248-.103-.508-.15-.765-.15V4H14c-1.105 0-2 .895-2 2s.895 2 2 2h7.172L4.586 24.586C4.196 24.976 4 25.488 4 26s.195 1.024.586 1.414c.78.78 2.047.78 2.828 0z"/></symbol>
