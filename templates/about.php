		...
		<article class="article">
			...
			<div class="article__content">
				...
				<section>
					...
					<p>All code included in this project, apart from included libraries, was custom written through the duration of the contest. None of it is copy and pasted from elsewhere.</p>
